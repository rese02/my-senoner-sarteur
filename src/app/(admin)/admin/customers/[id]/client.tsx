...
export function CustomerDetailClient({ customer: initialCustomer, orders: initialOrders, customerId }: CustomerDetailClientProps) {
            ...
            <div>
                ...
                <p>Der Kunde mit der ID {customerId} konnte nicht gefunden werden.</p>
                 <Button asChild variant="outline" className="mt-4">
                    <Link href="/admin/customers"><ArrowLeft className="mr-2 h-4 w-4" />Zurück zur Übersicht</Link>
                </Button>
            </div>
        );
    }
