  ...
  return (
    <div className="w-full min-h-[100dvh] flex items-center justify-center bg-secondary p-0 md:p-4 relative overflow-hidden">
        ...
        <div className="relative z-10 w-full md:max-w-sm">
            <Card className="flex flex-col justify-center shadow-2xl border-none rounded-none md:rounded-2xl bg-card text-card-foreground min-h-[100dvh] md:min-h-0 overflow-hidden md:min-h-auto">
                <CardContent className="flex flex-col items-center justify-center text-center p-8 md:p-10 w-full bg-primary text-primary-foreground">
                    <div className="h-12 mb-6">
                        <Link href="/">
                            <Image src="/logo.png" alt="Senoner Sarteur Logo" width={160} height={40} className="h-full w-auto object-contain" />
                        </Link>
                    </div>
                    <CardTitle className="text-3xl font-headline text-primary-foreground mb-6">My Senoner Sarteur</CardTitle>
