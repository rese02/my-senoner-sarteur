          ...
          <section>
            ...
            <div className="space-y-6 text-sm">
                ...
                <div>
                    ...
                    <p className="mt-2"><strong>Haftungsausschluss für KI-Inhalte:</strong> Die durch KI generierten Inhalte (z.B. Weinempfehlungen, optimierte Texte) können Fehler oder Ungenauigkeiten enthalten. Wir übernehmen keine Haftung für die Richtigkeit, Vollständigkeit oder Aktualität dieser maschinell erstellten Informationen. Sie sollten nicht als alleinige Grundlage für Entscheidungen dienen.</p>
                ...
                <div>
                    ...
                    <p>Sie haben das Recht auf Auskunft, Berichtigung, Löschung, Einschränkung der Verarbeitung, Datenübertragbarkeit und Widerspruch bezüglich Ihrer personenbezogenen Daten. Sie haben auch das Recht, Ihr Konto und die damit verbundenen Daten jederzeit über Ihre Profil-Einstellungen zu löschen. Für weitere Anfragen kontaktieren Sie uns bitte unter der oben genannten E-Mail-Adresse.</p>
                </div>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-6 text-sm">
                ...
                <div>
                    ...
                    <p className="mt-2"><strong>Esclusione di responsabilità per i contenuti IA:</strong> I contenuti generati dall'IA (ad es. consigli sui vini, testi ottimizzati) possono contenere errori o imprecisioni. Non ci assumiamo alcuna responsabilità per la correttezza, completezza o attualità di queste informazioni generate automaticamente. Non dovrebbero essere utilizzate come unica base per le decisioni.</p>
                ...
                <div>
                    ...
                    <p>Hai il diritto di accesso, rettifica, cancellazione, limitazione del trattamento, portabilità dei dati e opposizione riguardo ai tuoi dati personali. Hai anche il diritto di cancellare il tuo account e i dati associati in qualsiasi momento tramite le impostazioni del tuo profilo. Per ulteriori richieste, ti preghiamo di contattarci all'indirizzo e-mail sopra indicato.</p>
                </div>
            </div>
          </section>
            ...
            <section>
                ...
                <div className="space-y-6 text-sm">
                    ...
                    <div>
                        ...
                        <p className="mt-2"><strong>Disclaimer for AI Content:</strong> Content generated by AI (e.g., wine recommendations, optimized texts) may contain errors or inaccuracies. We assume no liability for the accuracy, completeness, or timeliness of this machine-generated information. It should not be used as the sole basis for decisions.</p>
                    ...
                    <div>
                        ...
                        <p>You have the right to access, rectify, erase, restrict processing of, and port your personal data, as well as the right to object. You also have the right to delete your account and its associated data at any time via your profile settings. For further inquiries, please contact us at the email address provided above.</p>
                    </div>
                </div>
            </section>
