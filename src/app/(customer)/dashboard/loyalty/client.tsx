...
// Lazy load the QR code component - This is now safe inside a Client Component
...
export function LoyaltyClient({ user }: { user: User }) {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-6">
                    <Card className="shadow-lg bg-primary text-primary-foreground border-none">
                        <CardHeader>
                            <CardTitle className="text-primary-foreground">Ihr Status</CardTitle>
                        </CardHeader>
